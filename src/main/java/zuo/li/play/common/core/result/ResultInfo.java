...
public class ResultInfo {
     ...
     * 成功结果
     */
    public final static ResultInfo RESULT = new ResultInfo();
    ...
    public static ResultInfo error() {
        ResultInfo res = new ResultInfo(RESULT_CODE_ERROR, "ERROR");
        return res;
    }
    ...
    public static ResultInfo errorMessage(String errorMessage) {
        ResultInfo res = new ResultInfo(RESULT_CODE_ERROR, errorMessage);
        return res;
    }
